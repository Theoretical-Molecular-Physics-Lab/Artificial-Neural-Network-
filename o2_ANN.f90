...
!---------------------------------------------------------------------
	...
	! 
       ...
       !                                       network for V(R)
       ! 
	ann_O2 = fann_create_from_file(f_c_string('NN_O2.dat')) 
	! 
	return
...
!----------------------------------------------------------------------
	...
	! 
       ...
       !                                       network for V'(R)
       ! 
	ann_dV = fann_create_from_file(f_c_string('dV_O2.dat')) 
	! 
	return
...
!-----------------------------------------------------------------------
    ...
    ! 
    r(1) = x
    v=f_fann_run(ann_O2,r)
    pot=v(1)  - 0.190216914           ! well depth value for O2 molecule (in a.u.)
    return
    end function pot
!----------------------------------------------------------------------
!----------------------------------------------------------------------
...
!----------------------------------------------------------------------
    ...
    ! 
    real(kind=4):: x
    real(kind=4),parameter::dx=0.00001      
    !   
...
open(UNIT=mrm_a+1,FILE='o2_potential.res')       
! 
call initialize()
call begin()
write(*,*)' '                                                                                         
write(*,*)' '                                                                                         
write(*,*)'Diatomic system: O2 (ground state)' 
write(*,*)'Level of theory: CASPT2/AVQZ' 
